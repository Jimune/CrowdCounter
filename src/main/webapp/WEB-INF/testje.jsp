...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="first-slide" src="https://cdn.pixabay.com/photo/2017/05/15/23/48/survey-2316468_1280.png"
                 alt="First slide" width="300px" height="auto>
            <div class=" container">
    ...
    <div class="item">
        <img class="second-slide" src="http://codechoco.gov.co/portal/img/encu.png" alt="Second slide">
        <div class="container">
            <div class="carousel-caption">
    ...
    <div class="item">
        <img class="third-slide" src="http://static.noticiasdegipuzkoa.com/common/imgs/ico.mobile.png" alt="Third slide"
